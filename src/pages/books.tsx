...
export const Books = () => {
    ...
    const filtered = genreFilter ? books.filter((b) => b.genre.toLowerCase().includes(genreFilter)) : books;
                ...
                <div className="max-w-6xl mx-auto px-5 relative z-[2]">
                    <div className="hero-fade-in mb-8 md:mb-12">
                        ...
                        <p className="text-text-secondary leading-relaxed md:text-lg mt-4 max-w-lg">
                            rated, discussed, and documented - from first page to final verdict. pick a genre or browse
                            them all.
                        </p>
                    </div>
