        ...
        <div className="max-w-4xl mx-auto px-5 py-12">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-4">
                    <Link
                        to="/admin/new"
                        className="bg-accent text-white px-5 py-2 rounded-full text-sm font-semibold uppercase tracking-wider hover:bg-accent-hover transition-colors"
                    >
                        + add book
                    </Link>
                    <button
                        ...
                        >
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-0.5">
                                    ...
                                    <span
                                        className={`text-xs px-2 py-0.5 rounded-full font-medium uppercase tracking-wider shrink-0 ${statusStyles[book.status] ?? "bg-border text-text-secondary"}`}
                                    >
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                                <Link
                                    ...
                                    className="text-sm text-accent hover:text-accent-hover transition-colors px-3 py-1.5"
                                >
                                    edit
                                </Link>
