        ...
        <div className="max-w-4xl mx-auto px-5 relative z-[2]">
          <div className="hero-fade-in mb-12 md:mb-20">
            ...
            <p className="text-text-secondary leading-relaxed md:text-lg mt-5 max-w-xl">
              mt. hope book club was started by dominique & mohith — two UWI
              medical sciences students who wanted to read more intentionally.
              all readers are welcome to join.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-16 md:mb-24">
            <Animate>
              ...
              <p className="text-text-primary leading-relaxed">
                new book every few weeks. read at your own pace. meet up and
                talk it through.
              </p>
            </Animate>
            <Animate delay={100}>
              ...
              <p className="text-text-primary leading-relaxed">
                every book gets rated, quoted, and argued about. we track it all
