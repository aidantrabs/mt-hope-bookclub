        ...
        <div className="bg-bg-footer">
            <div className="max-w-6xl mx-auto px-5 pt-10 md:pt-14 pb-6">
                <div className="grid grid-cols-1 md:grid-cols-[1.2fr_1fr_1fr] gap-10 md:gap-8 pb-10 border-b border-border-dark">
                    ...
                    <div>
                        <p className="text-xs uppercase tracking-widest font-medium text-text-muted-dark mb-4">
                            navigate
                        </p>
                        <nav className="flex flex-col gap-2.5">
                            <Link
                                to="/"
                                className="text-sm text-text-muted-dark hover:text-text-on-dark transition-colors"
                            >
                                home
                            </Link>
                            <Link
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-2 pt-5">
                    ...
                    <Link
                        to="/admin"
                        className="text-xs text-text-muted-dark/60 hover:text-text-muted-dark transition-colors"
                    >
                        admin
                    </Link>
                </div>
