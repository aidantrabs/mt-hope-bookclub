          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Field label="final discussion" error={errors.dateFinalDiscussion} field="dateFinalDiscussion">
              <input
                ...
                onBlur={() => {
                  if (form.dateStarted && form.dateFinalDiscussion && form.dateFinalDiscussion < form.dateStarted) {
                    setErrors((prev) => ({ ...prev, dateFinalDiscussion: "must be on or after the start date" }));
                  }
                }}
