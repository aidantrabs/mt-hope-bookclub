...
export const Header = () => {
    ...
    return (
        <>
            <header
                className={`bg-bg-light/90 backdrop-blur-md border-b border-border sticky top-0 ${menuOpen ? "z-[60]" : "z-50"}`}
            >
                        ...
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `text-4xl font-bold transition-all duration-300 underline decoration-2 underline-offset-4 ${
                                    isActive
                                        ? "text-accent decoration-accent"
                                        : "text-text-primary decoration-transparent hover:text-accent hover:decoration-accent"
                                }`
                            }
                            style={{
